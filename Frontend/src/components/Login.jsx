...
function Login() {
    ...
    return (
        <div className='relative flex h-screen bg-repeat items-center m-0'>
            <div className=''>
                            ...
                            <div>
                                <form action="" className='flex flex-col gap-5'>
                                    <div className='flex justify-around gap-11'>
                                        <label className="input input-bordered flex items-center gap-2 bg-white w-96">
                                            <svg
                        ...
                        <div className='bg-gray-300 w-[40vw] h-screen items-center relative z-30 flex flex-col content-center justify-center text-black bg-no-repeat border shadow-lg p-14 gap-9 '>
                            ...
                            <div>
                                <form action="" className='flex flex-col gap-5'>
                                    <div className='flex justify-around gap-11'>
                                            <label className="input input-bordered flex items-center gap-2 bg-white w-96">
                                                <input type="text" className="grow text-white" placeholder="Enter Full Name" />
                                            </label>
                                            </div>
                                        <div className='flex justify-around gap-11'>
                                            <label className="input input-bordered flex items-center gap-2 bg-white w-96">
